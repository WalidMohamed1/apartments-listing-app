...
* Note: We pass the query function as a parameter to avoid circular dependencies
 
*/
 
export const seedDatabase = async (executeQuery: any) => {
  try {
    ...
    console.log('🌱 Starting database seed logic...');
    ...
    console.log('✅ Data seeded successfully via init process');
 
  } catch (error) {
 
    console.error('❌ Error inside seed script:', error);
